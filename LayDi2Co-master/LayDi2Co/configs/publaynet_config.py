...
def get_config():
    ...
    config.log_dir = Path('/root/private/LayDi2Co/logs')


    config.dataset_path = Path("/root/private/dataset/publaynet")
    ...
    config.optimizer.num_epochs_discrete = 200  # 200
    config.optimizer.num_epochs_continuous = 1200  # 1000

    config.optimizer.batch_size = 1024 # 64
