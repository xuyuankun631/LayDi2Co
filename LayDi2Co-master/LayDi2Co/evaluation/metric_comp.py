...
from metrics import get_layout_iou, get_alignment_loss_numpy, compute_overlap, compute_alignment, LayoutFID
from utils import convert_xywh_to_ltrb_batch
...
if __name__ == '__main__':
    ...
    res_path = Path('/root/private/ddcfg/logs/publaynet_final/samples-one-shot/results_whole_box.pkl')
    # res_path = Path('/root/private/ddcfg/logs/publaynet_final/samples/results_whole_box.pkl')


    # Specify the device (e.g., 'cuda:0' for the first GPU, 'cuda:1' for the second GPU)
    device = torch.device('cuda:1')  # Change to the GPU you want to use, e.g., 'cuda:1' for the second GPU.
